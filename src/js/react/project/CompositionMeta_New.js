...
function InputNote({ lane, field }) {
    return (
        <div className="form-node">
            <input type="area" name={field} placeholder={`Note for ${capitalize(lane)}`} className="form-control form-control-lg" />
        </div>
    );
}
    ...
    return (
        <form id="form-composition" className={`form form-lg`} onSubmit={handleSubmit((data) => console.log(data))}>
            ...
            <div className="form-panel">
                ...
                <div className="form-group">
                    <input type="area" name="general" placeholder="General" className="form-control form-control-lg" />
                </div>
